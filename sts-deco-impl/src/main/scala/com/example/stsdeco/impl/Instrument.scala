...
final case class ReutersId private (val value: String) extends AnyVal with WrappedValue[String]
...
final case class Currency private (val value: String) extends AnyVal with WrappedValue[String]
